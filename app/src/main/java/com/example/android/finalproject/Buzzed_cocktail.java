...
public class Buzzed_cocktail extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buzzed_cocktail);

        Button BZcocktail = (Button) findViewById(R.id.buzzedcocktail);
